    ...
    public unsafe struct H264SeqParamSet
    {
        ...
        public void Decode(byte[] buf)
        {
                ...
                profile_idc == 144) // old High444 profile
            {
                ...
                fixed (bool* list_present_flag = seq_scaling_list_present_flag, use_default_flag =
        ...
        private static void ReadScalingList(ref H264BitReader br, int id, byte* scaling_list, int list_size,
            bool* use_default_matrix)
        {
        ...
        private static void WriteScalingList(ref H264BitWriter bw, int id, byte* scaling_list, int list_size,
            bool* use_default_matrix)
        {
            var scan = id < 6 ? scan4x4 : scan8x8;
